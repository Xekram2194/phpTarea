...
<?php include(VIEW_FRONT . DS . "headAuth.php"); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post">
                                        ...
                                        <input type="submit" value="Iniciar Sesión" name="login" class="btn btn-primary btn-user btn-block">
                                    </form>
                                    <hr>
                                    <div class="text-center">
        ...
        <?php include(VIEW_FRONT . DS . "footerAuth.php"); ?>
